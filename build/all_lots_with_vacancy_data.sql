...
vacancy_by_bbl as (
  select distinct(bbl_key), range_start(session_range) as range_start from has_vacancy
)

select range_start as vacant_since, st_asgeojson(geo.geometry) as geometry, filtered.* from vacancy_by_bbl
